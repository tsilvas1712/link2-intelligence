<div class="w-full flex flex-col gap-4">
    ...
    <div class="bg-white w-full flex p-2">
        ...
        <div class="w-full flex gap-2 ">
            <x-choices
                class="w-full"
                label="Selecione as Filiais"
                wire:model.live="selectedFiliais"
                :options="$filiais"
                option-label="filial"
                height="w-full"
                icon="o-users"
            ...
            <x-choices
                ...
                wire:model.live="selectedVendedores"
                :options="$this->getVendedores()"
                option-label="nome"
                height="w-full"
                icon="o-users"
        ...
        <div class="flex flex-col justify-end items-center w-1/3">
            <x-button wire:click="updateDash" label="Atualizar" class="btn-primary"
                      spinner="updateDash"/>
        </div>
