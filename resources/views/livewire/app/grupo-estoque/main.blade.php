<div class="bg-white w-full h-full p-4 rounded">
   <x-header title="Grupo de Estoque" icon="s-boxes" separator />
    <div>
        <x-table :headers="$this->headers()" :rows="$this->getData()">
            ...
            @scope('actions',$row)
                <div class="flex gap-2">
                    <x-button class="btn bg-blue-300 btn-sm" icon="s-eye" link="{{route('grupo-estoque.show',$row->grupo_estoque)}}" />
